    ...
    <main>
        <section id="containerSection">
            <form action="atualizarArtista.php" method="post">
                <p>Aqui você pode atualizar as informações das suas playlists ou do seu artista favorito. <br>Informe o nome do artista abaixo</p>
                <input type="text" placeholder="Ex: Gisem" name="artista" id="artista">
